...
class DeleteNoteTest extends DuskTestCase
{
    ...
    public function testExample(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            ->assertPathIs('/note/2') //Setelah klik maka akan masuk ke halaman show note yang dituju
            ->press('Delete')//Klik button delete
            ->assertDontSee('Praktikum Automation Testing Laravel Dusk'); //Notes yang sudah dibuat berhasil dihapus
        });
    }
}